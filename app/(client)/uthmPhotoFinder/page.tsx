...
export default function Page() {
  ...
  const handleSearch = async (e: any) => {
    ...
    try {
      ...
      setImageUrl(null);
      toast.error(err.message || "Image not found. Please check your matric number.");
    } finally {
      setIsLoading(false);
    }
  };
    ...
    <div className="min-h-screen bg-black text-white px-4 sm:px-6 lg:px-8 py-20">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-base sm:text-lg text-neutral-400 mb-12">
          Enter your UTHM Matric Number to find your image effortlessly.
        </p>

        <Card className="bg-gray-900 border-gray-800 shadow-2xl rounded-xl">
          <CardContent className="p-6 sm:p-8">
            <form onSubmit={handleSearch} className="mb-8 flex flex-col sm:flex-row gap-4 items-stretch">
            ...
            <div className="text-center">
              {imageUrl ? (
                <div className="space-y-6">
                  ...
                  <p className="text-sm text-gray-400">Matric: {matricNo}</p>
                </div>
              ) : (
                <div className="py-12 flex flex-col items-center justify-center text-gray-500 border-2 border-dashed border-gray-800 rounded-xl">
                  ...
                  <p className="text-lg">Enter a matric number to find your photo</p>
                  <p className="text-sm mt-2">Example: AA210100, BB220200</p>
                </div>
              )}
            </div>
            ...
            {!imageUrl && !isLoading && (
              <div className="mt-8 p-4 bg-gray-800 rounded-lg border border-gray-700 text-left">
                ...
                <ul className="text-sm text-gray-400 space-y-1 list-disc list-inside">
                  <li>Enter your full matric number (e.g. AA210100)</li>
                  <li>The system will automatically detect your session year</li>
                  <li>Click "Find Photo" to search for your image</li>
                </ul>
              </div>
            )}
          </CardContent>
