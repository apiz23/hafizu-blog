		...
		<>
			<div className="min-h-screen space-x-3 px-5 pt-32 md:pt-52">
				<Card className="max-w-2xl mx-auto rounded-md bg-transparent border-none text-white">
					...
					<CardHeader>
						<GradualSpacing
							className="tracking-wider font-medium text-3xl md:text-5xl text-center  bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400 bg-opacity-50"
							text="UTHM Photo Finder"
						/>
						{/* <CardTitle className="tracking-wider font-medium text-3xl md:text-5xl text-center  bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400 bg-opacity-50">
